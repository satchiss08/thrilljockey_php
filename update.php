<?
 ...
 if (mysqli_connect_errno())
  ...
  $download = $_GET["download_id"];

  $update = mysqli_query($conexion,"UPDATE downloads SET remaining = ('$remaining'-1) WHERE product_id ='$product' AND user_id ='$user' AND id = '$download'");
